...
public class ActiveMQConfig {
    ...
    public ActiveMQConnectionFactory activeMQConnectionFactory (RedeliveryPolicy redeliveryPolicy){
        ...
        connectionFactory.setBrokerURL(metUrl);
        connectionFactory.setUserName(metUser);
        connectionFactory.setPassword(metPwd);
        connectionFactory.setRedeliveryPolicy(redeliveryPolicy);
        return connectionFactory;
    }

    @Bean(name = "MetJmsTemplate")
    ...
    @Bean(name="t2ListenerContainerFactory")
